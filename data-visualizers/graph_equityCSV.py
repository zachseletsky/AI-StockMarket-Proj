"""
Graphs equity OHLCV data for visual analysis and to confirm integrity

Currently does not label axis properly
"""
...
def graph_equity():
    ...
    figure = express.line(
        dataframe, x=dataframe.columns[0], y=dataframe.columns[1:], title="MSFT"
    )
